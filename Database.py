...
def send_mail(email,message):
    ...
    server.starttls()
    server.login("navimailingservice123@gmail.com","zmmuxvvutnukpmyd")
    server.sendmail("navimailingservice123@gmail.com",email,message)
    server.quit()
...
global key
key="sankshipthshetty@gmail.com"
selected_keys=[]
